...
public class AlipayConfig {
	...
	public static String notify_url = "http://2q7159459g.zicp.vip:56161/orders/pay/alipay_callback";

	// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
	/*public static String return_url = "http://localhost/alipay.trade.page.pay-JAVA-UTF-8/return_url.jsp";*/
    public static String return_url = "http://2q7159459g.zicp.vip:56161/web/profile/orders.html";
